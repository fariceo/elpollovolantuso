                    ...
                    <table style="margin:auto; margin-bottom: 20px;">
                        <tr>
                            ...
                            <td>
                                ...
                                <label for="especificacion_tarea">Especificación de la Tarea:</label>
                                <textarea  onblur="especificacion('<?php echo $mandados[id] ?>')" id="especificacion_tarea_<?php echo $mandados['id'] ?>" name="especificacion_tarea" rows="4" cols="50" placeholder="Escribe aquí los detalles de la tarea..."></textarea>
                            </td>   
                            </tr>
                                <?php $total += $mandados['precio']; ?>
                                <?php
