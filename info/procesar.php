...
<table>
    <tr style="padding-top: 35px">
        <td style="width: 200px;" onClick="ver_historial('<?php echo $busqueda_deudor['usuario'] ?>')">
            <?php echo $busqueda_deudor['usuario']; ?>
        </td>

        <!--actualizar saldo de deuda-->
                    <td style="width: 50px;" onClick="actualizar_cantidad('<?php echo $busqueda_deudor['usuario'] ?>')">
                        <?php echo " $ " . $busqueda_deudor['saldo_pendiente']; ?>
                    </td>

                    <!--accion-->
                    <td style="width: 50px" onClick="accion('<?php echo $busqueda_deudor['usuario'] ?>')">
                        <?php
                    ...
                    <td style="width:50px;padding-top: 20px"><button style="color: red;margin-left: 50px;"
                            onClick="eliminar_deuda('<?php echo $busqueda_deudor['id'] ?>')">X</button></td>
...
<div>
    ...
    ?>
</div> <!--buscar producto en tabla menu-->
...
if ($_POST['id_metodo_pago'] != "") {
    ...
    if ($usuario_deuda == 1) {
        ...
        //aumenta el credito del usuario
...
<!---muestra el menu del restaurante en index-->
